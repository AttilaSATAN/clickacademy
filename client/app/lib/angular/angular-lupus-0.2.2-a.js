...
var lupus = angular.module("lupus", ["lupus.acrophobia", "lupus.danceFloor",
    ...
    "lupus.service", 'lupus.evliya', 'lupus.mongolab'
]);
/**
 * @ngdoc service
...
angular.module('lupus.architect', []);
...
angular.module('lupus.upload', function (angularFileUpload) {})
    .factory('lupusFileUpload', function () {

    });
angular.module('lupus.mongolab', [])
    .factory('lupusMongolab', ['', function() {
